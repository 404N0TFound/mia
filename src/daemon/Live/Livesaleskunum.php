...
class Livesaleskunum extends \FD_Daemon{
    ...
    public function execute(){
        ...
        foreach($result as $liveInfo){
            //获取数量
            $sale_num_key = sprintf(\F_Ice::$ins->workApp->config->get('busconf.rediskey.liveKey.live_sale_num.key'),$liveInfo['id']);
            ...
            //发送售卖商品数量的消息
            $content = NormalUtil::getMessageBody(6,$liveInfo['chat_room_id'],0,'',['count'=>"$actual_count"]);
