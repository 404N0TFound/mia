...
class Koubei extends \mia\miagroup\Lib\Service {
    ...
    public function getKoubeiList($params, $isRealtime = true) {
        ...
        if ($params['auto_evaluate'] !== null && $params['auto_evaluate'] !== '' && in_array($params['auto_evaluate'], array(0, 1)) && intval($condition['id']) <= 0) {
            //是否展示默认好评，默认不展示
            $condition['auto_evaluate'] = $params['auto_evaluate'] ? 1 : 0;
        }
